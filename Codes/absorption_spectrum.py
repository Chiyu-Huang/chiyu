    ...
    **Parameters**
    ...
    def make_spectrum(self, input_object, output_file=None,
        ...
        **Parameters**
        ...
        if ('gas', 'temperature_mu') not in input_ds.derived_field_list:
            raise RuntimeError(
                "('gas', 'temperature_mu') field required to be present in %s "
    ...
    def _add_lines_to_spectrum(self, field_data, use_peculiar_velocity,
        ...
        for store, line in parallel_objects(self.line_list, njobs=njobs,
            ...
            # print(field_data[line['field_name']], len(field_data[line['field_name']]))
            # print(field_data[('gas', 'dl')], len (field_data[('gas', 'dl')]))
            ...
            if use_peculiar_velocity:
                ...
                vlos = np.zeros(field_data[('gas', 'temperature_mu')].size)

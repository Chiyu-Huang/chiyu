...
def generate_total_fit(x, fluxData, orderFits, speciesDicts,
        ...
        fitLim=.97, minLength=2,
        maxLength=1000, splitLim=.99,
        output_file=None, first = 1, last = 1):
    ...
    **Returns**
    ...
    return (allSpeciesLines,yFit,cBounds)
    ...
    **Returns**
    ...
    while True:
        ...
        fitP,success=optimize.leastsq(
            ...
            epsfcn=1E-10,maxfev=2000)       #maxfev by default is 1000
